...
![Quad coordinate system](images/quad_coords2.png)

![Triangle coordinate system](images/tri_coords.png)
...
!["Natural" tessellated quad (4x3)](images/quad_tess_simple1.png)

!["Natural" tessellated tri (3)](images/tri_tess_simple1.png)

Here's the _actual_ meshes that the tessellator will produce for the given input parameters:

![Actual tessellated quad (4x3)](images/quad_tess4x3.png)

![Actual tessellated tri (edges=inside=3)](images/tri_tess3.png)
...
![Asymmetrically tessellated quad](images/quad_tess_asym.png)

![Asymmetrically tessellated triangle](images/tri_tess_asym.png)
...
![Triangle with asymmetric tessellation, even inner TF](images/tri_tess_asym_even.png)
